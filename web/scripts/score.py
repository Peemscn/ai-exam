# -*- coding: utf-8 -*-
"""Scoring Model 100 คะแนน (น้ำหนักตามโจทย์ q3)   (รันจาก q3/web: python scripts/score.py)
...
for r in clean[:10]:
    s=r["scores"]
    print(f"{r['rank']:>2} {r['name'][:32]:32} {r['total']:>5} | {r['rating']}★({r['reviews']}) {r['distance_m']}m")
